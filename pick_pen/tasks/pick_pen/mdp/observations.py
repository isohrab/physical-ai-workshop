...
def pen_grasped(
    ...
    # TODO: Calculate the distance between object and end effector
    pos_diff = None  # YOUR CODE HERE:

    # TODO: Check if pen is grasped (close to end effector AND gripper is closed)
    grasped = None  # YOUR CODE HERE:
...
def put_pen_to_plate(
    ...
    # TODO: Check if pen is within plate boundaries in x direction
    pen_in_plate_x = None  # YOUR CODE HERE:

    # TODO: Check if pen is within plate boundaries in y direction
    pen_in_plate_y = None  # YOUR CODE HERE:
    ...
    # TODO: Check if gripper is open (released the pen)
    gripper_open = None  # YOUR CODE HERE:

    # TODO: Combine all conditions for successful placement
    placed = None  # YOUR CODE HERE
    placed = None  # YOUR CODE HERE
