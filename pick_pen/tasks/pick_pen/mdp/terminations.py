...
def task_done(
    ...
    for pen_cfg in pens_cfg:
        ...
        # TODO: Check if pen is within the x-range relative to plate
        done = None  # YOUR CODE HERE:
        done = None  # YOUR CODE HERE:

        # TODO: Check if pen is within the y-range relative to plate
        done = None  # YOUR CODE HERE:
        done = None  # YOUR CODE HERE:

        # TODO: Check if pen is within the height range relative to plate
        done = None  # YOUR CODE HERE:
        done = None  # YOUR CODE HERE:
    ...
    # TODO: Check if robot is at rest pose
    done = None  # YOUR CODE HERE:
